            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <a
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-[#A3CEF1] rounded-xl hover:bg-[#F9FBFC] transition-colors text-sm font-medium text-gray-700 shadow-sm"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-3 bg-[#24292e] text-white rounded-xl hover:bg-black transition-colors text-sm font-medium shadow-sm"
                >
